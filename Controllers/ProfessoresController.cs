...
namespace SGE.Controllers
{
    public class ProfessoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cpf,Email,Telefone,DataNascimento")] Professores professores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cpf,Email,Telefone,DataNascimento")] Professores professores)
        {
